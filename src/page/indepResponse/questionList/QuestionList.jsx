  ...
  const questionData = [
    {
        ...
        },
        {
            ...
            tooltip: '[예시]\n· 본인, 배우자 또는 직계가족이 독립성 준수대상 회사의 예적금/대출/증권예탁금/보험/회원권 등 보유 (금액 무관)',
    ...
    },
    {
        ...
        items: [
        {
            ...
            tooltip: '[예시]\n· 본인, 배우자 또는 직계가족이 현재 또는 과거 1년 이내 독립성 준수대상 회사와 고용관계가 있는 경우\n· 측근가족(형제/자매 등) 등이 독립성 훼손위협이 존재하는 독립성 준수대상 회사와의 고용관계가 있는 경우',
    ...
    },
    {
        ...
        items: [
        {
            ...
            tooltip: '[예시]\n· 본인, 배우자 또는 직계가족이 독립성 준수대상 회사(주요 주주 및 임원 포함)와 독립성 훼손위협이 존재하는 상거래를 한 경우',
